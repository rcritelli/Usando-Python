...
#     by the length of the word, plus 50 points if all n letters are used on the 
#     first word created.
...
# For example, 'weed' would be worth 32 points ((4+1+1+2) for the four letters, then 
#     multiply by len('weed') to get (4+1+1+2)*4 = 32). Be sure to check that the hand 
...
def dealHand(n):
    ...
    """
    hand={}
    numVowels = n // random.randrange(2,4)
    ...
    while calculateHandlen(hand) > 0:
        ...
        # Otherwise (the input is not a single period):
            ...
            # Otherwise (the word is valid):
                ...
                print(word, "earned", getWordScore(word,n), "points. Total:", score)
                # Update the hand 
...
def playGame(wordList, HAND_SIZE=7):
    """
